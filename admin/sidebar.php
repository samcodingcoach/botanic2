...
<aside id="sidebar"
    ...
    <nav class="flex-1 px-4 space-y-1 mt-4 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-slate-600">
        ...
        <a class="nav-item flex items-center gap-3 px-4 py-3 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
            href="<?php echo $basePath; ?>halaman/halaman.php" data-page="halaman">
        ...
        <a class="nav-item flex items-center gap-3 px-4 py-3 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
            href="<?php echo $basePath; ?>fo/fo.php" data-page="fo">
            <span class="material-symbols-outlined">phone</span>
            <span class="text-sm font-medium">Resepsionis</span>
        </a>
        <a class="nav-item flex items-center gap-3 px-4 py-3 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
            href="<?php echo $basePath; ?>hk/hk.php" data-page="hk">
            <span class="material-symbols-outlined">cleaning_services</span>
            <span class="text-sm font-medium">Housekeeping</span>
        </a>
        <a class="nav-item flex items-center gap-3 px-4 py-3 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
            href="<?php echo $basePath; ?>teknisi/teknisi.php" data-page="teknisi">
            <span class="material-symbols-outlined">engineering</span>
            <span class="text-sm font-medium">Teknisi</span>
        </a>
        <a class="nav-item flex items-center gap-3 px-4 py-3 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
            href="<?php echo $basePath; ?>guest/guest.php" data-page="guest">
            <span class="material-symbols-outlined">person</span>
            <span class="text-sm font-medium">Guest</span>
        </a>
        <a class="nav-item flex items-center gap-3 px-4 py-3 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
            href="<?php echo $basePath; ?>inap/reservation.php" data-page="reservation">
